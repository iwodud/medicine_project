...
class Medicine:
    ...
    Args:
        name (str): name of medicine with its dose per pill (for instance apap_600)
    ...
    def __add_medicine_to_dict(self, dict_name):
        """Adds name_dose of an instance (self.name + _ + self.dose), with dictionary containing its parameters as value, to dictionary with a given name (dict_name)"""
