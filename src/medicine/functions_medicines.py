...
def isolate_name(string: str) -> str:
    """isolates name of medicine from its instance's name (for example apap from apap_500)"""
...
def get_names_of_wanted_medicines(medicine_name: str, file_name='data.json') -> list[str]:
    """returns list of medicine_names from database matching given name (medicine_name). if you type in 'aspiryna' or 'aspiryna_100_ you get ['aspiryna_100'].
